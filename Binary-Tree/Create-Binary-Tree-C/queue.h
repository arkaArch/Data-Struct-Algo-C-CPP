...
typedef struct Queue {
    ...
    // We store the address of the array, inside which addresses of Nodes are storing.
    // So first pointer to store addresses of Node and second pointer for the Node array.
    Node** Q;
}Queue;
