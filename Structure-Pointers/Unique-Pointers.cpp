...
// We scoped the below line to see the destruction of this pointer before calling the array
    {
        // std::unique_ptr<UDT> a = std::unique_ptr<UDT>(new UDT);
        // Here we use a factory function which is a function that returns an object of a class.
