...
void vector_stl() {
    ...
    std::cout << "After insert one element capacity of v: " << v.capacity() << std::endl;
    v.pop_back();
    std::cout << "After popping last element size of v: " << v.size() << std::endl;
    std::cout << "After popping last element capacity of v: " << v.capacity() << std::endl;
    v.clear();
    std::cout << "After clearing size of v: " << v.size() << std::endl;
    std::cout << "After clearing last element capacity of v: " << v.capacity() << std::endl;
}
