...
int main() {
    std::cout << "10 | 6 = " << (10 | 6) << std::endl; // OR: 1010 | 0110 = 1110 = 14
    std::cout << "10 & 6 = " << (10 & 6) << std::endl; // AND: 1010 & 0110 = 0010 = 2
    int x = 10, y = 6;  // In statement (10 ^ 6) gcc will complain that it may be "1e6"
    std::cout << "10 ^ 6 = " << (x ^ y) << std::endl; // XOR(Exclusive Or): 1010 ^ 0110 = 1100 = 12

    std::cout << "10 << 1 = " << (10 << 1) << std::endl; // Left Shift by one: 1010 << 1 = 10100 = 20 = 10 * 2^1
    std::cout << "10 << 2 = " << (10 << 2) << std::endl; // Left Shift by two: 1010 << 2 = 101000 = 40 = 10 * 2^2
    // So if we left shift n by k it's become: n * 2^k
    std::cout << "20 >> 1 = " << (20 >> 1) << std::endl; // Right Shift by one: 10100 >> 1 = 1010 = 10 = 20 / 2^1
    std::cout << "20 >> 2 = " << (20 >> 2) << std::endl; // Right Shift by two: 10100 >> 2 = 101 = 5 = 20 / 2^2
