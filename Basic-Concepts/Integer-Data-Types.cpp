...
int main() {
     ...
     * For signed integers min number = (4294967295 - 1) / 2 = -2147483647 = 2^(32 - 1) - 1
     * And max number = (4294967295 - 1) / 2 + 1 = 2147483648 = 2^(32 - 1) */
    ...
    std::cout << "Overflow => INT_MAX + 1 = " << INT_MIN - 1 << std::endl;  // Underflow
