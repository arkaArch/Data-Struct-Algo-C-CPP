...
// Simple array implementation is not used in practice as it is not efficient. We can't push an element 
// in front though there are empty space. In practice we either use circular array or linked list.
