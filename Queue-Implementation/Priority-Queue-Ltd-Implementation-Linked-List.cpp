 ...
 * Here I implemented this by taking an array, whose elements are set as priority.
 * Like arr[0] has priority 1, arr[1] has priority 2 & so on. Now here arr[0] saves
 * the address of first node of priority no.1 elements, arr[1] saves the address of
 * first node of elements which have priority no.2 and so on. */
